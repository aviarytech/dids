import { EnvironmentVariableSecretResolver, JSONSecretResolver } from "$lib";
...
test("env var secret resolver can resolve a X25519KeyAgreementKey2019 JSON file", async () => {
  const secretFile = require("./fixtures/X25519KeyAgreementKey2019.example.json");
